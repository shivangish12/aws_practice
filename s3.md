...
. or .. as standalone paths

Sorting Behavior

Lexicographic order based on UTF-8 encoding.
...
Temporary credentials: until credentials expire

Console-generated: 1–12 hours

Security

Acts as bearer token
...
Glacier Instant	Archive, fast access
...
Delete objects after time period
...
Feature	CloudTrail	Server Logs
API visibility	Yes	No
Auth failures	No	Yes
